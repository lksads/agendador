...
CREATE TABLE `tb_agendamento` (
  ...
  `id_pessoa_evento` int(11) DEFAULT NULL,
  `id_sala` int(11) DEFAULT NULL,
  `id_departamento` int(11) DEFAULT NULL,
  `id_usuario_agendamento` int(11) DEFAULT NULL,
  `observacao` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_agendamento`),
  KEY `id_pessoa_evento` (`id_pessoa_evento`),
  KEY `id_sala` (`id_sala`),
  KEY `id_departamento` (`id_departamento`),
  KEY `id_usuario_agendamento` (`id_usuario_agendamento`),
  CONSTRAINT `tb_agendamento_ibfk_1` FOREIGN KEY (`id_pessoa_evento`) REFERENCES `tb_pessoa` (`id_pessoa`),
  CONSTRAINT `tb_agendamento_ibfk_2` FOREIGN KEY (`id_sala`) REFERENCES `tb_sala` (`id_sala`),
  CONSTRAINT `tb_agendamento_ibfk_3` FOREIGN KEY (`id_departamento`) REFERENCES `tb_departamento` (`id_departamento`),
  CONSTRAINT `tb_agendamento_ibfk_4` FOREIGN KEY (`id_usuario_agendamento`) REFERENCES `tb_usuario` (`id_usuario`)
...
INSERT INTO `tb_departamento` VALUES (0,'ATI');
...
INSERT INTO `tb_nivel_acesso` VALUES (0,'ADM');
...
CREATE TABLE `tb_pessoa` (
  ...
  KEY `tb_pessoa_ibfk_1` (`id_nivel_acesso`)
...
INSERT INTO `tb_pessoa` VALUES (0,'kygo',1),(1,'jojo',1);
...
INSERT INTO `tb_sala` VALUES (0,'sala01');
...
CREATE TABLE `tb_usuario` (
  ...
  CONSTRAINT `tb_usuario_ibfk_1` FOREIGN KEY (`id_pessoa`) REFERENCES `tb_pessoa` (`id_pessoa`),
  CONSTRAINT `tb_usuario_ibfk_2` FOREIGN KEY (`id_nivel_acesso`) REFERENCES `tb_nivel_acesso` (`id_nivel_acesso`),
  CONSTRAINT `tb_usuario_ibfk_3` FOREIGN KEY (`id_pessoa`) REFERENCES `tb_pessoa` (`id_pessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_usuario` VALUES (0,'adm',0,0,0);
...
-- Dump completed on 2023-01-06 14:54:51
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
